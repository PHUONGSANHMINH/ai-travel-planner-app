...
const Profile = () => {
  ...
  const handleSignOut = async () => {
    try {
      ...
      router.replace('/auth/sign-in'); // Use replace to navigate to sign-up screen
    } catch (error) {
  ...
  const handleShare = async () => {
    try {
      await Share.share({
        message: 'Check out this amazing app developed by KN, SM, VT! [App Link]',
      });
    } catch (error) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.footer}>
        Crafted with passion by KN, SM, VT. ✨ Bringing ideas to life, one
